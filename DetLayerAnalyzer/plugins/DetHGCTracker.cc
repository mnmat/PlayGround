...
DetHGCTracker::DetHGCTracker(const CaloGeometry* geom,
...
DetHGCTracker::~DetHGCTracker(){}

void DetHGCTracker::makeDiskLayers(std::vector<HGCDiskGeomDet*>disksSi, std::vector<HGCDiskGeomDet*> disksSc){
...
void DetHGCTracker::makeDisks(int subdet, const CaloGeometry* geom_, std::vector<HGCDiskGeomDet*> &disksPos, std::vector<HGCDiskGeomDet*> &disksNeg) {
...
const HGCDiskLayer* DetHGCTracker::nextDisk(const HGCDiskLayer * from, 
...
TYPELOOKUP_DATA_REG(DetHGCTracker);
