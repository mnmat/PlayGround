...
static constexpr auto s_tag = "[IsolationRequirementAnalyzer]";

TEST_CASE("Standard checks of IsolationRequirementAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("IsolationRequirementAnalyzer"
