...
#ifndef RecoMTD_DetLayers_HGCDisk_H
#define RecoMTD_DetLayers_HGCDisk_H
...
class HGCDisk : public GeometricSearchDet {
public:
  using GeometricSearchDet::GeometricSearchDet;

  /// Construct from iterators on GeomDet*
  HGCDisk(std::vector<const GeomDet*>::const_iterator first,
               std::vector<const GeomDet*>::const_iterator last,
               const MTDTopology& topo);

  /// Construct from a vector of GeomDet*
  HGCDisk(const std::vector<const GeomDet*>& dets, const MTDTopology& topo);
...
std::ostream& operator<<(std::ostream&, const HGCDisk&);
