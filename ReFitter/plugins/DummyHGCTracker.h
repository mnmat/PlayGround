#ifndef __RecoHGCal_TICL_DummyHGCTracker_H__
#define __RecoHGCal_TICL_DummyHGCTracker_H__
...
class DummyHGCTracker{
	public:
		DummyHGCTracker(const CaloGeometry *geom,
        ...
        const std::vector<HGCDiskLayer*> getDiskLayers(int zside) const { return zside > 0 ? diskLayerPos_ : diskLayerNeg_;}
