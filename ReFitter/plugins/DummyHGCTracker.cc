...
DummyHGCTracker::DummyHGCTracker(const CaloGeometry* geom,
...
DummyHGCTracker::~DummyHGCTracker(){}

void DummyHGCTracker::makeDiskLayers(std::vector<HGCDiskGeomDet*>disksSi, std::vector<HGCDiskGeomDet*> disksSc){
...
void DummyHGCTracker::makeDisks(int subdet, const CaloGeometry* geom_, std::vector<HGCDiskGeomDet*> &disksPos, std::vector<HGCDiskGeomDet*> &disksNeg) {
...
const HGCDiskLayer* DummyHGCTracker::nextDisk(const HGCDiskLayer * from, 
...
TYPELOOKUP_DATA_REG(DummyHGCTracker);
