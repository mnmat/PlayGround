...
static constexpr auto s_tag = "[SearchWindowAnalyzer]";

TEST_CASE("Standard checks of SearchWindowAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("SearchWindowAnalyzer"
